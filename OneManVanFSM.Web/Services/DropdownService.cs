...
public class DropdownService : IDropdownService
{
    ...
    private static readonly Dictionary<string, string[]> DefaultCategories = new()
    {
        ...
        ["InventoryCategory"] = ["Parts", "Supplies", "Equipment", "Filters", "Refrigerant", "Ductwork", "Electrical", "Plumbing", "Safety", "Tools", "Other"],
        ["ExpensePaymentMethod"] = ["Cash", "Check", "Card", "ACH", "Zelle", "Company Card", "Other"],
        ["InvoicePricingType"] = ["Material & Labor (Itemized)", "Flat Rate", "Time & Material", "Cost + Markup", "Service Agreement (Covered)"],
        ["QuickNoteCategory"] = ["Material", "Customer", "Equipment", "Safety", "Dispatch", "Other"],
        ["QuickNoteEntityType"] = ["Job", "Customer", "Asset", "Invoice", "Site"],
        ["Tonnage"] = ["1.5 Ton", "2 Ton", "2.5 Ton", "3 Ton", "3.5 Ton", "4 Ton", "5 Ton"],
        ["ProductEquipmentType"] = ["Air Conditioner", "Furnace", "Heat Pump", "Mini-Split"],
        ["EmployeeRole"] = ["Technician", "Manager", "Apprentice", "Admin", "Owner"],
        ["EmployeeStatus"] = ["Active", "Inactive", "OnLeave", "Terminated"],
        ["EstimateStatus"] = ["Draft", "Sent", "Approved", "Rejected", "Expired"],
        ["InvoiceStatus"] = ["Draft", "Sent", "Invoiced", "Paid", "Overdue", "Void"],
        ["ExpenseStatus"] = ["Pending", "Approved", "Reimbursed", "Denied"],
        ["CalendarEventStatus"] = ["Tentative", "Confirmed", "Completed", "Cancelled"],
        ["CoverageLevel"] = ["Basic", "Standard", "Premium", "Custom"],
        ["AgreementStatus"] = ["Pending", "Active", "Expiring", "Expired", "Cancelled", "Renewed"],
        ["ServiceHistoryType"] = ["WarrantyClaim", "NonWarrantyRepair", "PreventiveMaintenance"],
        ["ServiceHistoryStatus"] = ["Open", "Submitted", "InProgress", "Approved", "Denied", "Resolved"],
